    ...
    magnify: 1
      ...
      <div class="col-md-7 single-top-left ">
        ...
        <ul class="social-top">
          ...
          <div class="add add-3">
                       <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="Wheat" data-summary="summary 1" data-price="6.00" data-quantity="1" data-image="{{url('frontend/images/si.jpg')}}">Add to Cart</button>
                    </div>
